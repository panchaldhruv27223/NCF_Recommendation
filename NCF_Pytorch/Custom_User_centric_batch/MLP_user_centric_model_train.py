...
if __name__ == "__main__":
    ...
    main(learner = 'adam', layers= [32, 16, 8], epochs = 10, batch_size = -1, num_factors = 10, num_neg = -1, topK= 10, shuffle=False, shuffle_users=True, shuffle_within_user=True, output_folder_path=f"MLP_User_centric_pos_neg_eq", output_folder_path_log = f"MLP_User_centric_pos_neg_eq")